...
export default function Register() {
  ...
  const getDestination = (u) =>
    fromPath && fromPath !== '/register' ? fromPath : `/meowdex/${u.uid}`;
    ...
    <div className="page-shell auth-page">
      <div className="auth-glass-card">
        ...
        <div className="auth-brand">
          ...
          <div className="auth-brand-sub">{auth.registerTitle}</div>
        </div>
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          <div className="auth-field-wrap">
            <label className="auth-field-label">{auth.displayName}</label>
        ...
        <div className="auth-footer">
          ...
          <Link to="/login" className="auth-link-inline">{strings.nav.login}</Link>
        </div>
      </div>
    </div>
  );
